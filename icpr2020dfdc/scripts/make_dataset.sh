...
# python extract_faces.py --source data/datasets/celebdfv2 --videodf data/celebdf_videos.pkl --facesfolder output/celebdf/faces --facesdf output/celebdf/dfs --checkpoint output/celebdf/checkpoints
